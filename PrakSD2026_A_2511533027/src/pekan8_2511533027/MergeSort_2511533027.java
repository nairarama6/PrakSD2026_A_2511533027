...
public class MergeSort_2511533027 {
	void merge_3027(int arr_3027[], int l_3027, int m_3027, int r_3027) {
		...
		int R_3027[] = new int[n2_3027];
		 ...
		 void sort_3027(int arr_3027[], int l_3027, int r_3027) {
			 if (l_3027 < r_3027) {
				 // Find the middle point
				 int m_3027 = (l_3027 + r_3027) / 2;
				 // Sort first and second halves
				 sort_3027(arr_3027, l_3027, m_3027);
				 sort_3027(arr_3027, m_3027 + 1, r_3027);
				 // Merge the sorted halves
				 merge_3027(arr_3027, l_3027, m_3027, r_3027);
			 }
		 }
		 /* A utility function to print array of sixe n */
		 static void printArray_3027(int arr_3027[]) {
		 ...
		 public static void main(String[] args) {
			 ...
			 printArray_3027(arr_3027);
			 MergeSort_2511533027 ob_3027 = new MergeSort_2511533027();
			 ob_3027.sort_3027(arr_3027, 0, arr_3027.length - 1);
